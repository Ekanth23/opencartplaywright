...
```
TypeError: _randomDataGenerator.RandomDataGenerator.generateRandomFirstName is not a function
```
...
```ts
  ...
  28 |     const regPage = new RegistrationPage(page);
> 29 |     await regPage.setFirstName(RandomDataGenerator.generateRandomFirstName());
     |                                                    ^ TypeError: _randomDataGenerator.RandomDataGenerator.generateRandomFirstName is not a function
  30 |     await regPage.setLastName(RandomDataGenerator.generateRandomLastName());
  31 |     await regPage.setEmail(RandomDataGenerator.generateRandomEmail());
  32 |     await regPage.setTelephone(RandomDataGenerator.generateRandomPhoneNumber());
  33 |     const password = RandomDataGenerator.generateRandomPassword();
  34 |     await regPage.setPassword(RandomDataGenerator.generateRandomPassword());
  35 |     await regPage.setConfirmPassword(RandomDataGenerator.generateRandomPassword());
  36 |     regPage.acceptPrivacyPolicy;
  37 |     regPage.clickContinue;
  38 |     const confirmationMessage = regPage.isConfirmationMessageDisplayed;
  39 |     expect(confirmationMessage).toContain('Your Account Has Been Created!'); 
