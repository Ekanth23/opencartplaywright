...
```
TypeError: Cannot read properties of undefined (reading 'getRandomFirstName')
```
...
```ts
  ...
  17 | import {RandamDataUtil} from '../utils/randomDataGenerator'
...
> 30 |     await regPage.setFirstName(RandamDataUtil.getRandomFirstName)
     |                                               ^ TypeError: Cannot read properties of undefined (reading 'getRandomFirstName')
  31 |     await regPage.setLastName(RandamDataUtil.getRandomFirstName);
  32 |     await regPage.setEmail(RandamDataUtil.generateRandomEmail());
  33 |     await regPage.setTelephone(RandamDataUtil.generateRandomPhoneNumber());
  34 |     const password = RandamDataUtil.generateRandomPassword();
  35 |     await regPage.setPassword(RandamDataUtil.generateRandomPassword());
  36 |     await regPage.setConfirmPassword(RandamDataUtil.generateRandomPassword());
  37 |     regPage.acceptPrivacyPolicy;
  38 |     regPage.clickContinue;
  39 |     const confirmationMessage = regPage.isConfirmationMessageDisplayed;
